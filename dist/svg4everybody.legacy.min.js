...
if(b){for(// create a document fragment to hold the contents of the target
var c=document.createDocumentFragment(),d=a;d&&!/svg/i.test(d.nodeName);)d=d.parentNode;
// cache the closest matching viewBox
var e=!d.getAttribute("viewBox")&&b.getAttribute("viewBox");
// conditionally set the viewBox on the svg
e&&d.setAttribute("viewBox",e);
...
var c=0;c<o.length;){
// get the current <use>
var i=o[c],j=i.parentNode;if(j){var k=i.getAttribute("xlink:href")||i.getAttributeNS("http://www.w3.org/1999/xlink","href");
